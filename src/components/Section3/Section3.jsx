        ...
        <section className='flex flex-col mb-[90px] lg:mb-[149px]'>
            ...
            <div className='hidden lg:block'>
                <div className='flex lg:w-[418px] lg:h-[3px] float-right'>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="1258.067 2703.583 417.867 2.833"><path d="M1260.5 2706h415" strokeLinejoin="round" strokeLinecap="round" strokeWidth="2" stroke="#e6332a" fill="transparent" dataname="Línea 8"/></svg>
                </div>
            </div>
