...
function Arrow({arrow}) {
    return <>
        {
            (arrow === 'left') &&
            <svg xmlns="http://www.w3.org/2000/svg" width="15%" viewBox="387.567 1857.083 273.367 272.85">
        ...
        {
            (arrow === 'straight') &&
            <svg xmlns="http://www.w3.org/2000/svg" width="25%" viewBox="1258.067 2703.583 417.867 2.833">
        ...
        {
            (arrow === 'right') &&
            <svg xmlns="http://www.w3.org/2000/svg" width="15%" viewBox="1382.583 5563.083 289.85 290.833">
