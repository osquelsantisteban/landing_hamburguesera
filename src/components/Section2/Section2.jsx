        ...
        <section className='relative flex flex-col my-10 mb-20'>
            ...
            <div className='flex justify-between mt-20'>
                <div className='flex -z-30'>
                    <svg xmlns="http://www.w3.org/2000/svg" width="273.367" height="272.85" viewBox="387.567 1857.083 273.367 272.85"><path d="m390 1859.5 270.5 270" stroke-linejoin="round" stroke-linecap="round" stroke-width="2" stroke="#e6332a" fill="transparent" data-name="Línea 7"/></svg>
                </div>
