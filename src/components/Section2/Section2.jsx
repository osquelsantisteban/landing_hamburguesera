        ...
        <section className='relative flex flex-col my-10 mb-20'>
            ...
            <div className='mb-20'>
                ...
                <div className='z-30 flex px-2 py-4 lg:px-3 lg:py-14'>
                    <h1 className='z-30 text-2xl lg:text-7xl'>Diferente<br/> hamburguesa,<br/>diferente<br/> experiencia</h1>
                </div>
            ...
            <div className='flex justify-between mt-20'>
                <div className='flex w-16 h-16 -z-30 lg:w-72 lg:h-72'>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="387.567 1857.083 273.367 272.85"><path d="m390 1859.5 270.5 270" stroke-linejoin="round" stroke-linecap="round" stroke-width="2" stroke="#e6332a" fill="transparent" data-name="Línea 7"/></svg>
                </div>
